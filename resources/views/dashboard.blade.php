                ...
                <div class="flex gap-4">
                    ...
                    @auth
                        @if ($user->id === auth()->user()->id)
                            <a href="{{route('perfil.index')}}" class="mt-1 text-gray-600 hover:text-gray-900">
                ...
                @auth
                    @if ($user->id !== auth()->user()->id)
                        ...
                        />
                            ...
                            <input 
                                type="submit"
                                class=" bg-blue-600 text-white rounded-md px-3 py-1 uppercase text-xs font-bold cursor-pointer"
                                value="seguir"
                            />
                        </form>
                        ...
                        />
                            ...
                            <input 
                                type="submit"
                                class=" bg-red-600 text-white rounded-md px-3 py-1 uppercase text-xs font-bold cursor-pointer"
