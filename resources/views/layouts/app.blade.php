    ...
    <body class=" bg-slate-100">
        <header class="p-5 border-b bg-white">
            ...
            <div class="container mx-auto flex justify-between items-center">
                ...
                @auth
                    <nav class="flex flex-col sm:flex-row gap-3 items-center">
                        <a 
                            class="flex items-center gap-3 bg-white border p-2 text-gray-600 rounded text-sm uppercase font-bold cursor-pointer" 
        ...
        <footer class="mt-10 uppercase text-center p5 text-gray-500 font-bold p-10">
